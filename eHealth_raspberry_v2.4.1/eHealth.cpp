...
//***************************************************************
	...
	{	
		...
		float ganancia=5.0;
		float Vcc=3.3;
		float RefTension=2.8; // Voltage Reference of Wheatstone bridge.
		float Ra=4642.0; //Wheatstone bridge resistance.
		float Rc=4645.0; //Wheatstone bridge resistance.
		float Rb=818.0; //Wheatstone bridge resistance.
	...
	void eHealthClass::readPulsioximeter(void)
	{
		...
		for (int i = 0; i<41 ; i++) { // read all the led's of the module
			...
			delayMicroseconds(270); //300 microseconds			
